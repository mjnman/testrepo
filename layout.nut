...
local marquee = FadeArt("marquee", blip*0.2360, blip*0.1050, blip*0.6750, blip*0.1580 );
...
//cabinet image -------------------------------------- START
local cab = fe.add_image( "cab_body.png", 0, 0, blip*1.350, blip*1.150);
